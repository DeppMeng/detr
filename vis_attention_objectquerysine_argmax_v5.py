...
for idxx, img_id in enumerate(id_list):
    ...
    for count in range(20):
        ...
        obj_embed = model.obj_trans(obj_embed)
        ...
        plt.savefig('vis_attn_v4_transv2_sineobjquery_direct_attention/idx{}_layer{}_objectquerysine_sum.png'.format(img_id, 0, count), format='png')